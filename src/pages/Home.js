  ...
  return (
    <div className="home">
      <Helmet>
        ...
        />
        <link rel="canonical" href="https://felixbacon-online.github.io/" />
      </Helmet>
      <Navigation />
        ...
        <div className="content">
          <div className="container-header">
            ...
            <h1 id="neon-text" className="neon title-wordpress">
              ...
              <a
                className="title-wordpress"
                href="https://felixbacon.fr"
                target="_blank"
                rel="noopener noreferrer"
              >
                <div class="bottom-marge">Création de sites web WordPress</div>{" "}
                sites vitrine & e-commerce{" "}
                <span class="lowercase">(Cliquez ici !)</span>
              </a>
            </h1>
          </div>
